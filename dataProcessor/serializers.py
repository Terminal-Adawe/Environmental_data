...
class Waste_ManagementSerializer_serializer(serializers.Serializer):
	...
	organic_waste_source = serializers.ListField(max_length=100)
	organic_waste_weight = serializers.ListField(max_length=100)
...
class IncidentReportSerializer_serializer(serializers.Serializer):
	...
	incident_start = serializers.DateTimeField()
	incident_end = serializers.DateTimeField()
