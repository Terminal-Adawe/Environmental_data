...
from dataProcessor.serializers import FuelFarmSerializer_serializer
...
class FuelFarmViewSet(viewsets.ViewSet):
    def create(self, request):
        queryset = FuelFarm.objects.all()

        serializer = FuelFarmSerializer_serializer(data=request.data)
